...
<?php include 'includes/head.php'; ?>
    ...
    <title>XENOFEAR</title>
</head>
<body>
<div id="texte_a_afficher" class="texte_inselectionnable" style="height: 569px;">
<span class="stabilisation"></span><p style="text-align: center;"><strong>POLITIQUE DE CONFIDENTIALITÉ</strong></p>
<p style="text-align: center;"><strong>DU SITE&nbsp;: </strong></p>
<p style="text-align: center;"><strong><span id="span_id_nom_du_site" class="encours"><span class="variable_vide">XENOFEAR</span></span> </strong></p>
<p><br><br></p>
<p style="text-align: center;"><strong>ARTICLE 1&nbsp;: PRÉAMBULE<br><br></strong></p>
<p>Cette politique de confidentialité s'applique au site&nbsp;: <span id="span_id_nom_du_site" class="encours"><span class="variable_vide">XENOFEAR</span></span>. <br><br></p>
...
<p style="padding-left: 30px;"><span id="span_id_url_cgu" class="encours"><span class="variable_vide">XENOFEAR</span></span></p>
...
<p>Les données à caractère personnel collectées sur le site <span id="span_id_nom_du_site_internet" class="encours"><span class="variable_vide">XENOFEAR</span></span> sont les suivantes&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_liste_donnees_collectees"><span class="variable_vide">XENOFEAR</span></span></p>
<p>Ces données sont collectées lorsque l'utilisateur effectue l'une des opérations suivantes sur le site&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_operations_collectes_donnees"><span class="variable_vide">XENOFEAR</span></span> </p>
<p>Le responsable du traitement conservera dans ses systèmes informatiques du site et dans des conditions raisonnables de sécurité l'ensemble des données collectées pour une durée de&nbsp;: <span id="span_id_duree_conservation_donnees"><span class="variable_vide">XENOFEAR</span></span>.</p>
<p>La collecte et le traitement des données répondent aux finalités suivantes&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_finalite_traitement_donnees"><span class="variable_vide">XENOFEAR</span></span></p>
<p>Les traitements de données effectués sont fondés sur les bases légales suivantes&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_bases_legales"><span class="variable_vide">XENOFEAR</span></span></p>
...
<p>Le site <span id="span_id_nom_du_site_internet" class="encours"><span class="variable_vide">XENOFEAR</span></span> est hébergé par&nbsp;: <span id="span_id_denomination_sociale_de_l_hebergeur"><span class="variable_vide">XENOFEAR</span></span>, dont le siège est situé à l'adresse ci-après&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_siege_social_de_l_hebergeur"><span class="variable_vide">XENOFEAR</span></span></p>
<p>L'hébergeur peut être contacté au numéro de téléphone suivant&nbsp;: <span id="span_id_telephone_de_l_hebergeur"><span class="variable_vide">XENOFEAR</span></span>. </p>
<p>Les données collectées et traitées par le site sont exclusivement hébergées et traitées en France. </p>
<p style="text-align: center;"><br><strong>ARTICLE 4&nbsp;: RESPONSABLE DU TRAITEMENT DES DONNÉES </strong></p>

<p style="padding-left: 30px;"><strong>A. </strong>LE RESPONSABLE DU TRAITEMENT DES DONNÉES</p>
<p>Le responsable du traitement des données à caractère personnel est&nbsp;: <span id="span_id_prenom_nom_responsable"><span class="variable_vide">XENOFEAR</span></span>. Il peut être contacté de la manière suivante&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_methode_contact_rtd"><span class="variable_vide">XENOFEAR</span></span></p>
...
<p style="padding-left: 30px;"><span id="span_id_procedure_acces_donnees"><span class="variable_vide">XENOFEAR</span></span> </p>
...
<p style="padding-left: 30px;"><span id="span_id_procedure_suppression_compte"><span class="variable_vide">XENOFEAR</span></span><br><br></p>
...
<p style="padding-left: 30px;"><span id="span_id_procedure_portabilite_donnees_personnelles"><span class="variable_vide">XENOFEAR</span></span></p>
...
<p style="padding-left: 30px;"><span id="span_id_procedure_limitation_traitement"><span class="variable_vide">XENOFEAR</span></span><br><br></p>
...
<p style="text-align: center;"><br><strong>ARTICLE 6&nbsp;: UTILISATION DES FICHIERS "COOKIES"<br><br></strong></p>
...
<p style="padding-left: 30px;"><span id="span_id_consentement_cookies"><span class="variable_vide">XENOFEAR</span></span></p>
...
<p style="padding-left: 30px;"><span id="span_id_liste_cookies"><span class="variable_vide">XENOFEAR</span></span> </p>
...
<p style="padding-left: 30px;"><span id="span_id_tiers_cookies"><span class="variable_vide">XENOFEAR</span></span> </p>
...
<p style="text-align: center;"><strong>ARTICLE 7&nbsp;: CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ<br><br></strong></p>
<p>La présente politique de confidentialité peut être consultée à tout moment à l'adresse ci-après indiquée&nbsp;:</p>
<p style="padding-left: 30px;"><span id="span_id_adresse_politique_confidentialite"><span class="variable_vide">XENOFEAR</span></span></p>
...
<p>Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le&nbsp;: 09 / 12 / 2009.</p>
